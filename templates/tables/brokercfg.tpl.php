...
?>
  <div class="app-action-bar" id="bctrl">
    <div class="btn-group">
      ...
      <a id="app-action-edit" class="btn disabled" rel="tooltip" title="<?= $lang_array['app']['brokercfg_actions_edit'] ?>">
        <i class="icon icon-edit"></i> <?= $lang_array['act']['edit'] ?>
      </a>
      <a id="app-action-clone" class="btn disabled" rel="tooltip" title="<?= $lang_array['app']['brokercfg_actions_clone'] ?>">
