<?php
  ...
  $lang_array['app']['day'] = 'Jour';
  $lang_array['app']['week'] = 'Semaine';
  $lang_array['app']['month'] = 'Mois';
  $lang_array['app']['year'] = 'Année';
  ...
  $lang_array['app']['start'] = 'Début';
  $lang_array['app']['end'] = 'Fin';
  ...
  $lang_array['app']['author'] = "Auteur";
  $lang_array['app']['createdon'] = "Crée le";
  $lang_array['app']['updatedon'] = "Mis à jour le";
  ...
  $lang_array['app']['running_algos'] = 'Algorithmes lancés';
  $lang_array['app']['trade_stats'] = 'Statistiques de trades';

  $lang_array['app']['total'] = 'Total';
  $lang_array['app']['winning'] = 'Gagnants';
  $lang_array['app']['losing'] = 'Perdants';
  $lang_array['app']['neutral'] = 'Neutres';

  $lang_array['app']['history'] = 'Historique des Trades';
  ...
  $lang_array['app']['settings_password'] = 'Mot de Passe';
  $lang_array['app']['settings_nav1'] = 'Compte';
  $lang_array['app']['settings_nav2'] = 'Mot de Passe';
  $lang_array['app']['settings_nav3'] = 'Configurations';
  $lang_array['app']['settings_password_ph2'] = 'Nouveau mot de passe';
  $lang_array['app']['settings_password_ph3'] = 'Nouveau mot de passe (2)';
  $lang_array['app']['settings_timezone'] = 'Zone de temps';
  $lang_array['app']['settings_timezone_ph'] = 'votre zone de temps';
  $lang_array['app']['settings_preflang'] = 'langue preferée';


  $lang_array['app']['corecfg_actions_activate'] = "Activer la configuration";
  $lang_array['app']['corecfg_actions_edit'] = "Editer la configuration";
  ...
  $lang_array['app']['backtest_genetics_title'] = 'Paremètres génétiques';

  $lang_array['app']['population'] = 'Population';
  $lang_array['app']['survivors'] = 'Survivants';
  $lang_array['app']['converge_thold'] = 'Seuil de convergeance';
  $lang_array['app']['max_generations'] = 'Générations Maximum';

  $lang_array['app']['editor_resize_small'] = 'Repasser à la vue normale';
  ...
  $lang_array['app']['doc_ta'] = 'Analyse Technique';
  $lang_array['app']['doc_broker'] = 'Passage d\'ordre';
  
  $lang_array['app']['doc_datastruct'] = 'Structures de Données';
  $lang_array['app']['doc_datasources'] = 'Sources de Données';
  $lang_array['app']['doc_quant'] = 'Analyse Quantitative';
  ...
  $lang_array['app']['git_delbranch_hint'] = 'Selectionnez la branche à supprimer';
  ...
  $lang_array['app']['strategy_actions_notebook'] = 'Voir le Notebook.';

  $lang_array['app']['insertimage'] = 'Inserer une Image';
  $lang_array['app']['insertlink'] = 'Inserer un Lien';
